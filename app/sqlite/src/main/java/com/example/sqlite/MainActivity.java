...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button create_db=findViewById(R.id.create_database);//创建数据库
        Button add_data=findViewById(R.id.add_data);//添加数据
        Button update_data=findViewById(R.id.update_data);//更改数据
        Button delete_date=findViewById(R.id.delete_data);//删除数据
        Button query_data=findViewById(R.id.query_data);//查询数据
        Button bookInfo=findViewById(R.id.bookInfo);//查看图书信息
        Button addBook=findViewById(R.id.addBook);//添加图书
        ...
        add_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.execSQL("insert into Book(name,author,pages,price) values(?,?,?,?)",
                        new String[]{"Android","GuoLin","908","123.9"});
            }
        });
